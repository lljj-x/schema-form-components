...
import { SchemaField, fieldProps, vueUtils } from '@lljj/vue-json-schema-form';
...
var script = {
  ...
  props: _objectSpread2(_objectSpread2({}, fieldProps), {}, {
    fieldProps: {
      type: null,
      default: null
    }
      ...
      var res = properties.map(function (name) {
        return {
          ...
          schemaProps: _objectSpread2(_objectSpread2({}, _this.$props), {}, {
            ...
            curNodePath: vueUtils.computedCurPath(_this.curNodePath, name)
          })
        };
      });
      return res;
...
export { __vue_component__ as TabField };
